     ...
     <div class="row">
          ...
          if (isset($_GET['albumid'])) {
               ...
               <div class="col-md-3 mt-2">
                         <div class="card">
                              <img height="12rem;" src="../asset/img/<?php echo $data['lokasifile'] ?>" card="card-img-top" title="<?php echo $data['judulfoto'] ?>" style="height: 12rem;">
                              <div class="crad-footer text-center">
                                   ...
                                   ?>
                                   <a href=""><i class="fa-regular fa-comment"></i><?php 
